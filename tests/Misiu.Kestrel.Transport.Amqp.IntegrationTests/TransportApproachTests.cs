...
public class TransportApproachTests : IAsyncLifetime
{
    ...
    private WebApplication? _clientApp;
    ...
    public async Task InitializeAsync()
    {
        ...
        _clientApp = TestServerFactory.CreateTransportClient(
            _rabbitMq.HostName,
            _rabbitMq.Port,
            _rabbitMq.UserName,
            _rabbitMq.Password);
        ...
        var addresses = _gatewayServer.Urls.ToList();
        _gatewayBaseUrl = addresses.First();
